...
<style>
	...
	.section .slidewrap {max-width:1100px; margin:0 auto; overflow:hidden; position:relative;}
	...
	.section .slide-control .left {left:30px;background:url('resources/img/left.png') center center / 100% no-repeat;}
	.section .slide-control .right {right:30px;background:url('resources/img/right.png') center center / 100% no-repeat;}
