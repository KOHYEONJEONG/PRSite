...
public class MemberController {
	...
	@RequestMapping(method=RequestMethod.POST, value="/nickNameCheck")
	@ResponseBody
	public int nickNameCheck(@RequestParam("nickname") String nickname) {
		//아이디 체크
		System.out.println("userNickNameCheck 진입 , nickName : " + nickname);
		
		MemberDao dao = new MemberDao();
		
		int cnt = dao.joinNickNameCheck(nickname);
