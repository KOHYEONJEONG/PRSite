...
<body class="sub_page">
	...
	<!-- modify_view section -->
	<div align="center"
		style="border: 1px solid lightgray; margin: 10px 470px 10px 470px; padding: 10px">
		<form method=post action="./modify" name="modify_v"
			onSubmit="return check_write()">
			...
			<table cellpadding="5px">
				...
				<tr>
					<td>NO.</td>
					<td><input type="text" name="b_no" value="${content_view.bno}"
						readonly></td>
				</tr>
